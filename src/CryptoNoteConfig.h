...
namespace parameters {
  ...
  const uint64_t MONEY_SUPPLY                                  = UINT64_C(85898690560);
  ...
  const uint64_t GENESIS_BLOCK_REWARD                          = 1000000;
...
const char     CRYPTONOTE_NAME[]                             = "GoldCoin";
...
const int      P2P_DEFAULT_PORT                              = 1995;
const int      RPC_DEFAULT_PORT                              = 1996;
